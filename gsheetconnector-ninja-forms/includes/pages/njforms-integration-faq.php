...
<div class="tab-full">
	<button class="collapsible"><?php echo esc_html( __('How to configure your Google Spreadsheet with njforms plugin?')); ?></button>
	<div class="content">
		<ul>
			<li><?php echo esc_html( __('Go to the njforms Menu and click on  Googlesheet .')); ?></li>
			...
			<p>
		<img class="alignnone" src="<?php echo NINJAFORMS_GOOGLESHEET_URL . 'assets/img/faq-screenshot1.png'; ?>" />
		</p>
			<li><?php echo esc_html( __('Enter Google Sheet name and Google Sheet tab name inside the Google Sheet tab..')); ?></li>
			<p>
		<img class="alignnone" src="<?php echo NINJAFORMS_GOOGLESHEET_URL . 'assets/img/faq-screenshot2.png'; ?>" />
		</p>
		</ul>
	</div>
</div>
<div class="tab-full">
	...
	<div class="content">
		...
		<p><?php echo esc_html( __('And then try to activate the plugin again. This will create a debug.log under wp-content folder.&nbsp;Check for njforms google sheet connector error if so send us the file at support@westerndeal.com')); ?></p>
		<p><?php echo esc_html( __('2) Check the log that is created by njforms google sheet. For that click “View” from goggle sheet integration page. Let us know if there is any error we will assist you.')); ?></p>
...
<div class="tab-full">
	...
	<div class="content">
		<ol>
			<li><?php echo __('On the&nbsp;<code>Admin Panel &gt; njforms &gt; Google Sheets.</code>'); ?></li>
...
<div class="tab-full">
	<button class="collapsible"><?php echo esc_html( __('Why I am not showing njforms Values(submitted data) in My Googlesheet?')); ?></button>
	<div class="content">
		<p><?php echo esc_html( __('Sometimes it can take a while of spinning before it goes through. But if the entries never show up in your Sheet then one of these things might be the reason:')); ?></p>
		<ul>
