    ...
    public function css($gks_slider, $isSlider)
    {
          ...
          echo "
    			$scope .owl-carousel {
    				...
    				padding-right: {$sliderPadding}px;
    			}";
          ...
          echo "$scope .owl-carousel .gks-slider-cell .gks-slide-txt-btn {
                  ...
                  border-color: {$textButtonBgColor} ;
          ...
          if ($textButtonDisplayStyle == GKSTextButtonDisplayStyle::Jelly ||
            ...
            echo "$scope .owl-carousel .gks-slider-cell .gks-slide-txt-btn:after {
                    background-color: {$textButtonTextColor} ;
              }";
        ...
        if ($isCarousel) {
          ...
          $captionCss .= "
              $scope .gks-slide-txt-btn {
                  font-size: ".$textButtonFontSize."px !important;
                  line-height: ".($textButtonFontSize + 2)."px !important;
                  align-self: ". $options[GKSOption::kTextButtonAlignment].";
          ";
          if ($options[GKSOption::kTextButtonFontStyle] == 'italic') {
              $captionCss .= "
              font-style: {$options[GKSOption::kTextButtonFontStyle]};
              font-weight: normal;
          ";
          } else {
              $captionCss .= "
              font-weight: {$options[GKSOption::kTextButtonFontStyle]};
          ";
          }
        }
