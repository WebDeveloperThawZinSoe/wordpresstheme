    ...
    function fetchData(){
        ...
        for($i=0; $i<count($results); $i++){
            ...
            $actions = array(
                ...
                'duplicate' => sprintf('<a href="?page=%s&action=%s&id=%s&gks_nonce=%s" class="gks-duplicate-btn" style="float: left; margin-right: 7px;"><i class="fa gks-fa fa-copy" style="font-size: 14px;padding: 5px 0 0 6px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'duplicate',$sid, $nonce),
            );
