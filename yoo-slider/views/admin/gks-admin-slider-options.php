...
<div class="gks-preview-win-container">
  ...
  <div class="gks-preview-win-content" >
    <iframe id="gks-preview-iframe" src="<?php echo $_SERVER['REQUEST_URI'] . '&yoopreview=1'?>" width=100% height=600px; style="opacity: 0;"></iframe>
...
<script>
    ...
    function reloadSliderPreview(){
      ...
      frame.src = "<?php echo $_SERVER['REQUEST_URI'] . '&yoopreview=1'?>";

      // document.getElementById("gks-preview-iframe").contentDocument.location.reload(true);
    }
